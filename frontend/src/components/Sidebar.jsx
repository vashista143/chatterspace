...
const Sidebar = ({ sidebarusers, selecteduser, onlineUsers, setselecteduser }) => {
    return (
    <div className="md:w-80 w-40 h-full bg-base-200 text-white border-r border-white/10 md:pl-4 pl-1 pb-4 pr-2 pt-4 flex flex-col">
